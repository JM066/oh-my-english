...
import { type LoginValues, type AuthLogin, type SignUpValues } from '../../types/Auth'
...
export const doUserLogin = async (params: LoginValues): Promise<void> => {
  try {
...
export const doCreateUser = async (params: SignUpValues): Promise<void> => {
  try {
